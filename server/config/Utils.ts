...
class Utils {
  ...
  /**
   * List of files to create if not exists for different file types (workspace, news...)
   */
  public static filesHierarchy: any;
   ...
   * TMDB Api token
   */
  public static tmdbToken: string;

  /**
   * TVDB Api token
   */
  public static tvdbToken: string;
  ...
  public static init(): void {
    ...
    this.sessionSecret = 'eyg*lesec;retpEtit!lapinrose4238';
    this.userHash = 'EygleMaxiHashDeLaMort';
  ...
  public static hasId(value: any) {
    return value && value._id && Utils.isMongoId(value._id);
  }
